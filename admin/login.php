...
<body>
				...
				<div class="mt-5">
					...
					<div class="d-flex flex-column ">
						<form method='post' action="">
							...
							<input type="submit" class="btn btn-lg btn-primary btn-block btn-signin" value="Login" /><br>
						</form>
						<div class="mt-3">
							<p class="mb-0 text-muted">Does not have any account?</p>
							<div class="btn btn-primary"><a href="register.php">Register</a><span class="fas fa-chevron-right ms-1"></span></div>
						</div>
					</div>
				</div>
				<div class="mt-auto">
	...
	if (isset($_POST["username"]) or isset($_POST["password"])) {
		...
		if (empty($username)) {
			echo "Fill the username blank.";
		} else if (empty($password)) {
			echo "Fill the password blank.";
		} else {
